...
const values = [
    ...
    },
    {
        icon: Rocket,
        title: "مهمتنا",
        description: "توفير منصة تعليمية ذكية تجمع بين أفضل دورات البرمجة المجانية والذكاء الاصطناعي لرسم مسارات تعلّم مخصصة لكل مبرمج."
    },
    {
        icon: Heart,
        title: "قيمنا",
...
const features = [
    {
        icon: BookOpen,
        title: "دورات برمجة مجانية",
        description: "مئات الدروس المجانية في مجالات الويب، الذكاء الاصطناعي، قواعد البيانات، وتطوير التطبيقات."
    },
    {
        icon: Sparkles,
