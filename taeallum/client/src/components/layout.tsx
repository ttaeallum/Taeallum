          ...
          <div className="flex flex-col gap-5 text-right">
            ...
            <a href="mailto:info@taallm.com" className="flex items-center gap-3 justify-end group">
              ...
              <div className="w-9 h-9 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-all shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-primary group-hover:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <a href="https://www.instagram.com/taallm.jo/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 justify-end group">
              ...
              <div className="w-9 h-9 rounded-xl bg-pink-500/10 flex items-center justify-center group-hover:bg-pink-500 transition-all shrink-0">
                <svg className="w-4 h-4 text-pink-500 group-hover:text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Payment Badges */}
            <div className="mt-2">
              <p className="text-xs text-muted-foreground/60 mb-2">وسائل الدفع المقبولة</p>
              <div className="flex gap-2 justify-end flex-wrap">
                <div className="h-7 px-3 bg-white rounded-md flex items-center shadow-sm border border-gray-100">
                  <span className="font-black text-[#1A1F71] text-sm tracking-wider">VISA</span>
                </div>
                <div className="h-7 w-12 bg-white rounded-md flex items-center justify-center shadow-sm border border-gray-100">
                ...
                <div className="h-7 px-3 bg-black rounded-md flex items-center shadow-sm">
                  <span className="text-white font-semibold text-xs tracking-tight">Apple Pay</span>
                </div>
              </div>
            </div>
          </div>
