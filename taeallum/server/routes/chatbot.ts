...
3. الخيارات الإلزامية: يجب أن تنتهي كل رسالة بخيارات (أزرار) ذات صلة بالسؤال المطروح بتنسيق [SUGGESTIONS: اسم الخيار الأول|اسم الخيار الثاني|اسم الخيار الثالث]. (مثال: إذا كان السؤال عن الوقت، الخيارات تكون: دراسة صباحية|دراسة ليلية).
