...
تحديد القطاع المهني والهدف. بمجرد وضوح المجال (مثلاً تحليل البيانات)، أكد للطالب أنه "تم اعتماد مسار [المجال] كهدفك الرئيسي" وانتقل فوراً للمرحلة التالية. لا تعرض التسجيل في كورسات فردية في هذه المرحلة.
